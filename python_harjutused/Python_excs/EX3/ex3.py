...
#Lisa tingimuslause kui väärtus on 18 või suurem siis väljasta Terminali tekst
# "Võid hääletada Riigikogu valmistel"
...
#Testi muutuja number_to_check väärtust muutes ja programmi seejärel käivitades
#  kas tingimuslause töötab korrektselt
#---------------------Tingimuslause if .. else-----------------------
#Lisa fingimuslasuse, mis kontrollib kas isik on täiskasvanu. Kui vanus on 18 või suurem,
#  siis väljastab teksti "Oled täiskasvanu" kui alla, siis "Ei ole täiskasvanu"
